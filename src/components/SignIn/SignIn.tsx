        ...
        <div className="flex justify-center items-center min-h-screen background-three">
            <div className="form-section bg-white p-10 rounded-2xl">
                <div className="form-title flex flex-col gap-3">
                    <div className="logo">
                        <a href="#" className="logo flex items-center w-full gap-2 color-one">
                            <img
                ...
                <form className="mt-6 gap-3 flex flex-col">
                    ...
                    <div className="form-group">
                        <span>
                            <input
                                ...
                                className="h-14 background-three w-full p-3 bg-white password-black rounded-lg focus:outline-none"
                            />
                        </span>
                    </div>

                    <div className="text-end">
                        <a href="#" className="text-sm color-one" onClick={() => navigate("/forgot-password")}>Forgot Password?</a>
                    </div>

                    <div className="text-end">
                        <button
                            type="button"
                            className="w-full h-14 text-white bg-gradient-to-r from-purple-500 to-blue-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                        >
                            Sign In
                        </button>
                    </div>
                    ...
                    <span className="dec-color text-base">
                        ...
                        <a href="#" className="color-one text-base" onClick={() => navigate("/signup")}>
                            Sign up here
                        </a>
                    </span>
                </form>
