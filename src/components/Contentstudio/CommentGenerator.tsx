            ...
            <div className="shadow-lg bg-white rounded-xl p-6 space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        className="w-full min-h-32 resize-none border border-slate-300 rounded-lg p-2 text-sm focus:ring-2 focus:ring-blue-500"
                    />
                    ...
                    <div className="flex flex-wrap gap-2">
                        {commentTypes.map((type) => (
                            <button
                                ...
                                className={`px-3 py-1 rounded-full text-xs font-medium transition ${commentType === type.value
