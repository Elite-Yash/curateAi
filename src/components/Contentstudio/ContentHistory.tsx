...
const ContentHistory: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const posts = commentsData.filter(
      (c) => c.comment_type === "create-post"
    ).length;
        ...
        <div className="p-2.5 pt-0">
          <div className="border rounded-lg border-[#e0eaf3] ">
            ...
            <div className="grid grid-cols-12 gap-4 py-2 font-semibold bg-[#fff5f380] border-b border-[#e1eaf4] rounded-t-lg p-4">
              <div className="text-[14px] col-span-4">Message</div>
              <div className="text-[14px] col-span-2">Motive</div>
              <div className="text-[14px] col-span-2">Tone</div>
              <div className="text-[14px] col-span-1">Language</div>
              <div className="text-[14px] col-span-1">Status</div>
              {/* <div className="text-[14px]">URL</div> */}
              <div className="text-[14px] col-span-1">Date</div>
              <div className="text-[14px] col-span-1">Actions</div>
            </div>
              ...
              <div className="!border-[#e0eaf3] border-b h-125 overflow-auto">
                {filteredContent
                  ...
                  .map((c: any) => (
                    <div
                      key={c.id}
                      className="py-4 px-4 odd:bg-[#fff] even:bg-[#fff5f380] grid grid-cols-12 gap-4 items-start"
                    >
                      {/* Message */}
                      <div className="text-sm capitalize col-span-4">
                        <div
                      ...
                      {/* Motive */}
                      <div className="text-sm capitalize col-span-2">
                        {c.motive ?? "N/A"}
                      </div>
                      ...
                      {/* Language */}
                      <div className="text-sm capitalize col-span-1">
                        {c.language ?? "N/A"}
                      </div>
          ...
          <div className="bg-white rounded-lg max-w-full shadow-lg overflow-auto w-[1000px] max-h-[85vh] max-[1050px]:w-[95%]">
            ...
            <div className="p-6">
              <p
                className="mt-2.5"
                dangerouslySetInnerHTML={{
                  __html: escapeHtml(String(modalData.comment ?? "")).replace(
                    /\n/g,
                    "<br />"
                  ),
                }}
