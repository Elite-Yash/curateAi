...
const SideBar = () => {
    ...
    return (
        <div className="left-baar-menu w-72 max-[1400px]:w-64 max-[1150px]:-translate-x-64 h-screen bg-white fixed left-0 top-0 border bordere7e9f6 border-s-0 border-e-1 bordere7e9f6 border-b-0 border-t-0 z-20 transition">
            ...
            <div className="logo">
                <Link to="/" className="logo flex justify-center items-center w-full h-14 border bordere7e9f6 border-s-0 border-e-0 border-t-0">
                    <img src={getImage('iconLogo')} className="re-logo-b-o transition w-46" alt="img" />
                </Link>
            </div>
            ...
            <div className="left-menu">
                <ul className="flex flex-col">
                    {/* <li>
                        <Link to="/" className="flex items-center font-light color5a5783 gap-3 transition px-5 py-3 relative overlay-before">
                            <span className="icon w-4.5 h-4.5">
                                <img src={dashboard} alt="img" className="w-full h-full" />
                            </span>
                    ...
                    <li>
                        <Link to="/" className="flex items-center font-light color5a5783 gap-3 transition px-5 py-3 relative overlay-before">
                            <span className="icon w-4.5 h-4.5">
                                <img src={message} alt="img" className="w-full h-full" />
                            </span>
                            <span className="text-lg font-normal">Message</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/connect" className="flex items-center font-light color5a5783 gap-3 transition px-5 py-3 relative overlay-before">
                            <span className="icon w-4.5 h-4.5">
                                <i className="fas fa-link text-[#005684]"></i>
                            </span>
                            <span className="text-lg font-normal">Connect</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/template" className="flex items-center font-light color5a5783 gap-3 transition px-5 py-3 relative overlay-before">
                            <span className="icon w-4.5 h-4.5">
                                <i className="fas fa-file-alt text-[#005684]"></i>
                            </span>
                            <span className="text-lg font-normal">Template</span>
                        </Link>
                    </li>
                </ul>
            </div>
