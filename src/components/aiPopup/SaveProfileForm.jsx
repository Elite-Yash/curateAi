...
const SaveProfileForm = () => {
    ...
    <div className="popup-container bg-white rounded-lg shadow-lg w-96 absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 rounded-3xl overflow-hidden w-400">
        <div className="header-top p-9 py-10 flex justify-between item-center">
            ...
            <span className="close-box absolute top-6 right-6 w-6 h-6 bg-no-repeat bg-center cursor-pointer"><img src={getImage('close')} alt="img" className="w-full h-full rounded-full" /></span>
        </div>
        <div className="p-9 flex justify-between item-center flex-col gap-5">
            ...
            <div className="popup-buttons justify-end space-x-2 text-right relative">
                <button className="flex gap-2 ml-auto leading-6 popup-button-submit px-4 py-2 bg-indigo-500 text-white rounded-md hover:bg-indigo-600 disabled:bg-gray-400">
                    Save
                </button>
            </div>
        </div>
