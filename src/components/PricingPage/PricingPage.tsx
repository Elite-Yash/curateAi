                                        ...
                                        <div className="gap-5 !flex justify-center items-center mt-3">
                                            ...
                                            <div className={`price-box  p-6  w-72 background-three g-box ${activePlanDetails.id === allPlans[1]?.price_id ? "active" : ""}`} >
                                                ...
                                                <ul className="text-gray-700 space-y-2">
                                                    ...
                                                    <li className="flex items-center"><i className="fa-solid fa-check color-one w-4.5 h-4.5 flex justify-center items-center bg-white border border-color-one p-0 rounded-full text-[10px]"></i><span className="dec-color ml-2">Send Professional Replies</span></li>
