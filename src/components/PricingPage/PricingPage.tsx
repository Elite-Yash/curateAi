  ...
  const upgradeSubscription = async (data: any) => {
    ...
    const result = await Swal.fire({
      ...
      text: `Are you sure you want to ${
        activePlanDetails?.price > data?.price ? "Downgrade" : "Upgrade"
      } your subscription?`,
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: "#2563eb",
              ...
              <div className="p-5 bg-white g-box g-box-table ">
                <div className="d-table h-connect-table !w-full">
                  <div className="flex justify-between">
                    ...
                    <div className="flex space-x-4 items-center">
                      ...
                      >
                        <button
                          onClick={refresh}
                          className="background-white border border-[#2563eb] text-[#2563eb] px-5 py-3 text-base rounded-lg hover:!bg-[#2563eb] hover:!text-white transform"
                        >
                          <span>
                  ...
                  <div className="gap-5 !flex justify-center items-center mt-3">
                    ...
                    <div
                      className={`price-box  p-6  w-72 background-three g-box ${
